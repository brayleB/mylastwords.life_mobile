...
class _BodyState extends State<Body> {
  ...
  final _timePickerTheme = TimePickerThemeData(
    ...
    dayPeriodTextColor: MaterialStateColor.resolveWith((states) =>
        states.contains(MaterialState.selected) ? ColorTheme10 : ColorTheme2),
    ...
    dialTextColor: MaterialStateColor.resolveWith((states) =>
        states.contains(MaterialState.selected) ? ColorTheme2 : Colors.white),
                    ...
                    return ListView(
                      children: snapshot.data!.map<Widget>((alarm) {
                        ...
                        return GestureDetector(
                          onTap: () {
                            var editAlarmString = DateFormat('hh:mm aa')
                                                                      ...
                                                                      itemBuilder:
                                                                        ...
                                                                        return RadioListTile(
                                                                          activeColor:
                                                                              headerBackgroundColor,
                                                                          title:
                                                                              Text(_alarmSoundList[index].toString()),
                                                                          value:
                                                                              alarmSoundFiles[index],
                                                                          groupValue:
                                                                              selectedValue,
                                                                          selected:
                                                                              selectedValue == alarmSoundFiles[index],
                                                                          onChanged:
                                                                              (val) async {
                                                                            final duration = await player.setAsset(ringToneBaseUrl +
                                                                                alarmSoundFiles[index] +
                                                                                '.wav');
                                  ...
                                  children: <Widget>[
                                    ...
                                    Switch(
                                        ...
                                        onChanged: (bool value) {
                                          if (alarm.alarmOnOff == 'true') {
                                            _alarmHelper.updateOnOff(AlarmInfo(
                                                id: alarm.id,
                                                title: alarm.title,
                                                alarmDateTime:
                                                    alarm.alarmDateTime,
                                                ...
                                                sound: alarm.sound));
                                            loadAlarms();
                                            _alarmHelper.unScheduleAlarm(
                                                AlarmInfo(id: alarm.id));
                                          } else if (alarm.alarmOnOff ==
                                              'false') {
                                            _alarmHelper.updateOnOff(AlarmInfo(
                                                id: alarm.id,
                                                title: alarm.title,
                                ...
                                onPressed: () async {
                                  if (txtRepeat == "No Repeat") {
                                    ...
                                    for (var i = 0;
                                        ...
                                        i++) {
                                      if (_isChecked[i] == true) {
                                        var idStrSched = DateFormat('ddHHmmss')
                                                .format(DateTime.now()) +
                                            i.toString();
                                        ...
                                        _alarmHelper.scheduleAlarmRepeated(
                                            _dayDates[i], time, alarmInfoSched);
                                      }
                                    }
                                    _alarmHelper.insertAlarm(alarmInfo);
                                  }
